...
SLUG="xiaojiao_render_directive_preview_smoke_and_review_package_1010J"
EXPECTED_STATUS="XIAOJIAO_RENDER_DIRECTIVE_PREVIEW_SMOKE_AND_REVIEW_PACKAGE_PASS"
EXPECTED_MARKER="ALL_1010J_RENDER_DIRECTIVE_PREVIEW_SMOKE_AND_REVIEW_PACKAGE_CHECKS_OK"
REQUIRED_FILES=["docs/foundation/xiaojiao_render_directive_preview_smoke_and_review_package_1010J.md", "docs/foundation/xiaojiao_render_directive_preview_smoke_and_review_package_1010J.json", "samples/xiaojiao_render_directive_preview_smoke_and_review_package_1010J/render_directive_preview_smoke_trace_1010J.json", "docs/audit/xiaojiao_render_directive_preview_smoke_and_review_package_1010J_result.json", "docs/audit/xiaojiao_render_directive_preview_smoke_and_review_package_1010J_report.md", "scripts/validate_xiaojiao_render_directive_preview_smoke_and_review_package_1010J.py", "docs/audit_packages/xiaojiao_render_directive_preview_smoke_and_review_package_1010J_manifest.json", "docs/audit_packages/xiaojiao_render_directive_preview_smoke_and_review_package_1010J.zip"]
