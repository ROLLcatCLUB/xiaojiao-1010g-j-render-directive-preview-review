...
SLUG="xiaojiao_render_directive_adapter_contract_1010G"
EXPECTED_STATUS="XIAOJIAO_RENDER_DIRECTIVE_ADAPTER_CONTRACT_PASS"
EXPECTED_MARKER="ALL_1010G_RENDER_DIRECTIVE_ADAPTER_CONTRACT_CHECKS_OK"
REQUIRED_FILES=["docs/foundation/xiaojiao_render_directive_adapter_contract_1010G.md", "docs/foundation/xiaojiao_render_directive_adapter_contract_1010G.json", "samples/xiaojiao_render_directive_adapter_contract_1010G/render_directive_adapter_sample_1010G.json", "docs/audit/xiaojiao_render_directive_adapter_contract_1010G_result.json", "docs/audit/xiaojiao_render_directive_adapter_contract_1010G_report.md", "scripts/validate_xiaojiao_render_directive_adapter_contract_1010G.py", "docs/audit_packages/xiaojiao_render_directive_adapter_contract_1010G_manifest.json", "docs/audit_packages/xiaojiao_render_directive_adapter_contract_1010G.zip"]
